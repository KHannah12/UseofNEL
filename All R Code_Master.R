...
predat1 <- read.csv("https://raw.githubusercontent.com/KHannah12/UseofNEL/main/GLM_PercAuth.csv") 
...
predat2 <- read.csv("https://raw.githubusercontent.com/KHannah12/UseofNEL/main/GLM_AuthCount_NoOut.csv")
...
#### Figure 6 - Binomial GLM with survey data ####
